...
<body>
		                    ...
		                    <div class="row m-l-0 m-r-0">
		                        <div class="col-sm-5 bg-c-lite-green user-profile">
		                            <div class="card-block text-center text-white">
		                                ...
		                                <h2>Doctor</h2> <i class=" mdi mdi-square-edit-outline feather icon-edit m-t-10 f-16"></i>
		                            </div>
		                        </div>
		                        <div class="col-sm-7">
		                            <div class="card-block">
		                                ...
		                                <div class="row">
		                                	 <div class="col-sm-12">
		                                        ...
		                                        <h6 class="text-muted f-w-700"><%=hospital.getSpecial() %></h6>
		                                    </div>
		                                ...
		                                <div class="row">
		                                	 <div class="col-sm-12">
		                                        ...
		                                        <h6 class="text-muted f-w-700"><%=hospital.getHos_name() %></h6>
		                                    </div>
     ...
     <br><br>
      <div class="right_area">
        <a href="/back" class="logout_btn">Back</a>
      </div>
      <center><h1><b>Update Profile</b></h1><br><br><br><br>
      <table cellpadding="10">
              <form method="post" action="updateProfile">
		       ...
		       <tr>
		         ...
		         <td><input type="text" name="special" value="<%=hospital.getSpecial()%>"></td>
		       </tr>
		       
		       <tr>
		         <td><b>Hospital Name</b></td>
		         <td><input type="text" name="hos_name" value="<%=hospital.getHos_name()%>"></td>
		       </tr>
		       <tr>
		         <td></td>
